...
Precision parameter (k) estimate: 55.6
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Late_Rift_Data_Analysis_files/Late_Rift_Data_Analysis_11_1.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Late_Rift_Data_Analysis_files/Late_Rift_Data_Analysis_16_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Late_Rift_Data_Analysis_files/Late_Rift_Data_Analysis_17_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.7\linewidth}{0.7\paperheight}}{Late_Rift_Data_Analysis_files/Late_Rift_Data_Analysis_21_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
8204  records read from  ../Data/SLB/magic\_measurements.txt
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Late_Rift_Data_Analysis_files/Late_Rift_Data_Analysis_28_1.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
8204  records read from  ../Data/SLB/magic\_measurements.txt
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Late_Rift_Data_Analysis_files/Late_Rift_Data_Analysis_29_1.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Late_Rift_Data_Analysis_files/Late_Rift_Data_Analysis_34_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
Precision parameter (k) estimate: 46.5
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Late_Rift_Data_Analysis_files/Late_Rift_Data_Analysis_38_1.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Late_Rift_Data_Analysis_files/Late_Rift_Data_Analysis_44_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
Precision parameter (k) estimate: 53.2
    ...
    \begin{center}
    \adjustimage{max size={0.7\linewidth}{0.7\paperheight}}{Late_Rift_Data_Analysis_files/Late_Rift_Data_Analysis_54_1.pdf}
    \end{center}
    
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}35}]:} \PY{n}{Michipicoten\PYZus{}Island\PYZus{}Fm}
\end{Verbatim}
...
Precision parameter (k) estimate: 35.4
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Late_Rift_Data_Analysis_files/Late_Rift_Data_Analysis_62_1.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
-10  -  119 percent unfolding
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Late_Rift_Data_Analysis_files/Late_Rift_Data_Analysis_70_4.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Late_Rift_Data_Analysis_files/Late_Rift_Data_Analysis_72_0.pdf}
    \end{center}
...
Precision parameter (k) estimate: 48.4
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Late_Rift_Data_Analysis_files/Late_Rift_Data_Analysis_77_1.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\begin{itemize}
\item{The paleolatitude for reference location (Duluth, MN) resulting from pole 1 (Osler Volcanic Group) is: 44.055\textdegree}
...
\item{The rate of paleolatitudinal change implied by the poles pairs is: 17.257 cm/yr}
\end{itemize}
...
\noindent 2.5\textsuperscript{th} percentile is: 14.518 cm/yr\\
...
\noindent 2.5\textsuperscript{th} percentile is: 11.576 cm/yr\\
...
\noindent 2.5\textsuperscript{th} percentile is: 13.929 cm/yr\\
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Late_Rift_Data_Analysis_files/Late_Rift_Data_Analysis_88_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
1078.4340 Ma
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Late_Rift_Data_Analysis_files/Late_Rift_Data_Analysis_91_1.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Late_Rift_Data_Analysis_files/Late_Rift_Data_Analysis_97_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Late_Rift_Data_Analysis_files/PhanerozoicAPWP_Jacobsville.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Late_Rift_Data_Analysis_files/Late_Rift_Data_Analysis_107_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
